...
{
    "distutils": {
        "name": "mixed_quantum.zeros_calc",
        "sources": [
            "zeros_calc.pyx"
        ]
    },
    "module_name": "mixed_quantum.zeros_calc"
}
END: Cython Metadata */
...
#define __PYX_HAVE__mixed_quantum__zeros_calc
#define __PYX_HAVE_API__mixed_quantum__zeros_calc
/* Early includes */
#include "pythread.h"
#include <string.h>
#include <stdlib.h>
...
/* Module declarations from 'mixed_quantum.zeros_calc' */
...
#define __Pyx_MODULE_NAME "mixed_quantum.zeros_calc"
extern int __pyx_module_is_main_mixed_quantum__zeros_calc;
int __pyx_module_is_main_mixed_quantum__zeros_calc = 0;

/* Implementation of 'mixed_quantum.zeros_calc' */
...
static const char __pyx_k_zeros_calc_pyx[] = "zeros_calc.pyx";
...
static const char __pyx_k_mixed_quantum_zeros_calc[] = "mixed_quantum.zeros_calc";
...
static PyObject *__pyx_n_s_mixed_quantum_zeros_calc;
...
static PyObject *__pyx_kp_s_zeros_calc_pyx;
static PyObject *__pyx_n_s_zeros_f;
static PyObject *__pyx_n_s_zip;
static PyObject *__pyx_pf_13mixed_quantum_10zeros_calc_zeros_f(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_func, PyObject *__pyx_v_x, PyObject *__pyx_v_kwargs); /* proto */
...
/* "mixed_quantum/zeros_calc.pyx":20
 * @cython.binding(True)
...
/* Python wrapper */
static PyObject *__pyx_pw_13mixed_quantum_10zeros_calc_1zeros_f(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_13mixed_quantum_10zeros_calc_zeros_f[] = "Calculate the zeros of func in the given range defined by x\n    Args:\n        func (function): Function to calculate the zeros\n        x (array): Array defining the range of values to calculate the zeros\n    **kwargs:\n        args = Optional arguments for func\n    Returns:\n        zeros: Array with the several zeros of the function\n    ";
static PyMethodDef __pyx_mdef_13mixed_quantum_10zeros_calc_1zeros_f = {"zeros_f", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_13mixed_quantum_10zeros_calc_1zeros_f, METH_VARARGS|METH_KEYWORDS, __pyx_doc_13mixed_quantum_10zeros_calc_zeros_f};
static PyObject *__pyx_pw_13mixed_quantum_10zeros_calc_1zeros_f(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_AddTraceback("mixed_quantum.zeros_calc.zeros_f", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_13mixed_quantum_10zeros_calc_zeros_f(__pyx_self, __pyx_v_func, __pyx_v_x, __pyx_v_kwargs);
...
static PyObject *__pyx_pf_13mixed_quantum_10zeros_calc_zeros_f(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_func, PyObject *__pyx_v_x, PyObject *__pyx_v_kwargs) {
  ...
  /* "mixed_quantum/zeros_calc.pyx":32
 *     # Define datatypes
 *     cdef:
 ...
 */
  ...
  /* "mixed_quantum/zeros_calc.pyx":33
 *     cdef:
 *         list f_variables = str(inspect.signature(func))[1:-1].split(", ")[1:]
 *         dict f_args = dict()             # <<<<<<<<<<<<<<
 *         int x_size = len(x) - 1, x_i
 ...
 */
  ...
  /* "mixed_quantum/zeros_calc.pyx":34
 *         list f_variables = str(inspect.signature(func))[1:-1].split(", ")[1:]
 *         dict f_args = dict()
 *         int x_size = len(x) - 1, x_i             # <<<<<<<<<<<<<<
 *         list zeros = list()
 ...
 */
  ...
  /* "mixed_quantum/zeros_calc.pyx":35
 *         dict f_args = dict()
 *         int x_size = len(x) - 1, x_i
 *         list zeros = list()             # <<<<<<<<<<<<<<
 *         double diff
 ...
 */
  ...
  /* "mixed_quantum/zeros_calc.pyx":40
 * 
 ...
 */
  ...
  for (;;) {
    ...
    /* "mixed_quantum/zeros_calc.pyx":41
 *     # Relate function variables with input args
 *     for (i, j) in zip(f_variables, range(len(f_variables))):
 *         f_args[i] = kwargs.get('args')[j]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "mixed_quantum/zeros_calc.pyx":44
 * 
 *     # Estimate the 0's location
 ...
 */
  ...
  /* "mixed_quantum/zeros_calc.pyx":45
 *     # Estimate the 0's location
 *     func_data = func(x, **f_args)
 *     for x_i in range(x_size):             # <<<<<<<<<<<<<<
 *         diff = abs(func_data[x_i + 1] - func_data[x_i])
 ...
 */
  ...
  for (__pyx_t_12 = 0; __pyx_t_12 < __pyx_t_11; __pyx_t_12+=1) {
    ...
    /* "mixed_quantum/zeros_calc.pyx":46
 *     func_data = func(x, **f_args)
 *     for x_i in range(x_size):
 *         diff = abs(func_data[x_i + 1] - func_data[x_i])             # <<<<<<<<<<<<<<
 *         if (diff > <double > max(abs(func_data[x_i + 1]),
 ...
 */
    ...
    /* "mixed_quantum/zeros_calc.pyx":48
 *         diff = abs(func_data[x_i + 1] - func_data[x_i])
 *         if (diff > <double > max(abs(func_data[x_i + 1]),
 *                                  abs(func_data[x_i]))) and (diff < 1):             # <<<<<<<<<<<<<<
 *             zeros.append(brentq(
 ...
 */
    ...
    /* "mixed_quantum/zeros_calc.pyx":47
 *     for x_i in range(x_size):
 *         diff = abs(func_data[x_i + 1] - func_data[x_i])
 *         if (diff > <double > max(abs(func_data[x_i + 1]),             # <<<<<<<<<<<<<<
 *                                  abs(func_data[x_i]))) and (diff < 1):
 ...
 */
    if (__pyx_t_15) {
      ...
      /* "mixed_quantum/zeros_calc.pyx":49
 *         if (diff > <double > max(abs(func_data[x_i + 1]),
 *                                  abs(func_data[x_i]))) and (diff < 1):
 *             zeros.append(brentq(             # <<<<<<<<<<<<<<
 *                 func, x[x_i], x[x_i + 1], args=kwargs.get("args")))
 ...
 */
      ...
      /* "mixed_quantum/zeros_calc.pyx":50
 *                                  abs(func_data[x_i]))) and (diff < 1):
 *             zeros.append(brentq(
 *                 func, x[x_i], x[x_i + 1], args=kwargs.get("args")))             # <<<<<<<<<<<<<<
 *         else:
 ...
 */
    ...
    /* "mixed_quantum/zeros_calc.pyx":52
 *                 func, x[x_i], x[x_i + 1], args=kwargs.get("args")))
 *         else:
 *             continue             # <<<<<<<<<<<<<<
 *     return zeros
 */
  ...
  /* "mixed_quantum/zeros_calc.pyx":53
 *         else:
 *             continue
 *     return zeros             # <<<<<<<<<<<<<<
 */
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "mixed_quantum.zeros_calc.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "mixed_quantum.zeros_calc.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "mixed_quantum.zeros_calc.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "mixed_quantum.zeros_calc._memoryviewslice", /*tp_name*/
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_mixed_quantum_zeros_calc, __pyx_k_mixed_quantum_zeros_calc, sizeof(__pyx_k_mixed_quantum_zeros_calc), 0, 0, 1, 1},
  ...
  {&__pyx_kp_s_zeros_calc_pyx, __pyx_k_zeros_calc_pyx, sizeof(__pyx_k_zeros_calc_pyx), 0, 0, 1, 0},
 ...
 */
  ...
  __pyx_codeobj__23 = (PyObject*)__Pyx_PyCode_New(2, 0, 12, 0, CO_OPTIMIZED|CO_NEWLOCALS|CO_VARKEYWORDS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__22, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_zeros_calc_pyx, __pyx_n_s_zeros_f, 20, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__23)) __PYX_ERR(0, 20, __pyx_L1_error)
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_mixed_quantum__zeros_calc) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "mixed_quantum.zeros_calc")) {
      if (unlikely(PyDict_SetItemString(modules, "mixed_quantum.zeros_calc", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "mixed_quantum/zeros_calc.pyx":6
 * 
 * import cython
 ...
 */
  ...
  /* "mixed_quantum/zeros_calc.pyx":7
 * import cython
 * from scipy.optimize import brentq
 * import inspect             # <<<<<<<<<<<<<<
 * # import numpy as np
 ...
 *     Args:
 */
  __pyx_t_2 = __Pyx_CyFunction_New(&__pyx_mdef_13mixed_quantum_10zeros_calc_1zeros_f, 0, __pyx_n_s_zeros_f, NULL, __pyx_n_s_mixed_quantum_zeros_calc, __pyx_d, ((PyObject *)__pyx_codeobj__23)); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 20, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_zeros_f, __pyx_t_2) < 0) __PYX_ERR(0, 20, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "mixed_quantum/zeros_calc.pyx":1
 * """             # <<<<<<<<<<<<<<
 * Cython Module to Calculate the zeros
 * """
 */
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init mixed_quantum.zeros_calc", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init mixed_quantum.zeros_calc");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
